...
#ifdef ERROR_RESULT_H 
#define SWITCH_ERR(code1, code2) code1
#else
#define SWITCH_ERR(code1, code2) code2
#endif
...
typedef struct {                                                                                                                    \
    ...
    size_t capacity;                                                                                                                \
                                                                                                                                    ...
                                                                                                                                    \
SWITCH_ERR(STRUCT_RESULT(ARR_STRUCT_NAME);,)                                                                                        \
                                                                                                                                    \
...
static SWITCH_ERR(ErrorCode,void) ARR_STRUCT_NAME##_init_with_capacity(ARR_STRUCT_NAME* arr, size_t initial_capacity) {             \
    assert(arr != NULL && "A valid array is expected");                                                                             \
    arr->elements = (TYPE*)malloc(initial_capacity * sizeof(TYPE));                                                                 \
    SWITCH_ERR(if(!arr->elements) return ERR_BAD_ALLOC;,)                                                                           \
    arr->size = 0;                                                                                                                  \
    arr->capacity = initial_capacity;                                                                                               \
    SWITCH_ERR(return ERR_EMPTY;,)                                                                                                  \
}                                                                                                                                   \
static SWITCH_ERR(ErrorCode,void) ARR_STRUCT_NAME##_reserve(ARR_STRUCT_NAME* arr, size_t reserved_capacity) {                       \
    assert(arr != NULL && "A valid array is expected");                                                                             \
    ...
    if(!tmp) return SWITCH_ERR(ERR_BAD_ALLOC,);                                                                                     \
    arr->elements = tmp;                                                                                                            \
...
static void ARR_STRUCT_NAME##_free(ARR_STRUCT_NAME* arr) {                                                                          \
    ...
    arr->capacity = 0;                                                                                                              \
                                                                                                                                    ...
                                                                                                                                    \
static SWITCH_ERR(ErrorCode,void) ARR_STRUCT_NAME##_push(ARR_STRUCT_NAME* arr, TYPE value) {                                        \
    assert(arr != NULL && "A valid array is expected");                                                                             \
    ...
    SWITCH_ERR(return ERR_EMPTY;,)                                                                                                  \
                                                                                                                                    ...
                                                                                                                                    \
static SWITCH_ERR(ErrorCode,void) ARR_STRUCT_NAME##_insert(ARR_STRUCT_NAME* arr, TYPE value, size_t index) {                        \
    assert(arr != NULL && "A valid array is expected");                                                                             \
...
static void ARR_STRUCT_NAME##_remove(ARR_STRUCT_NAME* arr, size_t index){                                                           \
    ...
    for(size_t i = index; i < arr->size; i++) {                                                                                     \
        arr->elements[i] = arr->elements[i+1];                                                                                      \
                                                                                                                                    ...
                                                                                                                                    \
static SWITCH_ERR(ErrorCode,void) ARR_STRUCT_NAME##_shrink(ARR_STRUCT_NAME* arr){                                                   \
    assert(arr != NULL && "A valid array is expected");                                                                             \
    ...
    SWITCH_ERR(return ERR_EMPTY;,)                                                                                                  \
                                                                                                                                    ...
                                                                                                                                    \
static SWITCH_ERR(ErrorCode,void) ARR_STRUCT_NAME##_resize(ARR_STRUCT_NAME* arr, size_t new_capacity){                              \
    assert(arr != NULL && "A valid array is expected");                                                                             \
...
static void ARR_STRUCT_NAME##_clear(ARR_STRUCT_NAME* arr){                                                                          \
    ...
    arr->size = 0;                                                                                                                  \
                                                                                                                                    ...
                                                                                                                                    \
static SWITCH_ERR(RESULT(ARR_STRUCT_NAME), ARR_STRUCT_NAME) ARR_STRUCT_NAME##_clone(ARR_STRUCT_NAME* arr1, ARR_STRUCT_NAME* arr2){  \
    assert(arr1 != NULL && "A valid array is expected");                                                                            \
    if(!arr2) {                                                                                                                     \
        ARR_STRUCT_NAME clone;                                                                                                      \
        SWITCH_ERR(ErrorCode er = ,)ARR_STRUCT_NAME##_init_with_capacity(&clone, arr1->capacity);                                   \
        SWITCH_ERR(if(er != ERR_EMPTY) return ERR(ARR_STRUCT_NAME, er);,)                                                           \
        clone.size = arr1->size;                                                                                                    \
        mempcpy(clone.elements, arr1->elements, arr1->size * sizeof(TYPE));                                                         \
        return SWITCH_ERR(OK(ARR_STRUCT_NAME, clone), clone);                                                                       \
    }                                                                                                                               \
    SWITCH_ERR(ErrorCode er = ,)ARR_STRUCT_NAME##_init_with_capacity(arr2, arr1->capacity);                                         \
    SWITCH_ERR(if(er != ERR_EMPTY) return ERR(ARR_STRUCT_NAME, er);,)                                                               \
    arr2->size = arr1->size;                                                                                                        \
    mempcpy(arr2->elements, arr1->elements, arr1->size * sizeof(TYPE));                                                             \
    return SWITCH_ERR(OK(ARR_STRUCT_NAME, *arr2), *arr2);                                                                           \
}                                                                                                                                   \
